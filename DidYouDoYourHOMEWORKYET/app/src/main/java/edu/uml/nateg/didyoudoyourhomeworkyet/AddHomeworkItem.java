...
public class AddHomeworkItem extends Activity {

    // 7 days in milliseconds - 7 * 24 * 60 * 60 * 1000
    private static final int SEVEN_DAYS = 604800000;

    private static final String TAG = "HYDYHY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_homework_item);

        mTitleText = (EditText) findViewById(R.id.title);
        mDescText = (EditText) findViewById(R.id.description);
        mDefaultPriorityButton = (RadioButton) findViewById(R.id.ItemmedPriority);
        ...
        submitButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HomeworkItem.packageIntent(data, description, titleString, priority, fullDate, percent);

                log(titleString + "  " + priority.toString() + "  " + description);
